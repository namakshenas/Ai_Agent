...
import stopIcon from '../assets/stopIcon2.png';
        ...
        <>
            ...
            <div className="stickyBottomContainer">
                ...
                <div className="sendButtonContainer">
                    ...
                    {isStreaming && <button className="cancelSendButton" onClick={handleAbortStreamingClick}><img style={{opacity:0.6, width:'20px'}} src={stopIcon}/></button>}
                </div>
            </div>
