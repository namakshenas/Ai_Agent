...
const CustomTextareaAlt = forwardRef(({textareaValue, setTextareaValue, currentContext, handleSendMessage_Streaming, activeConversationId} : IProps, ref : ForwardedRef<ImperativeHandle>) => {
...
export default CustomTextareaAlt
