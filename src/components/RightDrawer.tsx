...
export default function RightDrawer({activeAgent, setModalVisibility} : IProps){
    ...
    const [webSearchEconomy, setWebSearchEconomy] = useState(false)

    return(
        <aside className="rightDrawer">
            <label>Current Agent</label>
            <input spellCheck="false" type="text" value={activeAgent.getName()}/>
            <label>Model</label>
            <input spellCheck="false" type="text" value={activeAgent.getModelName()}/>
            <label>SystemPrompt</label>
            <div className='systemPromptContainer'>
                <input spellCheck="false" type="text" value={activeAgent.getSystemPrompt().length > 37 ? activeAgent.getSystemPrompt().substring(0, 34)+'...' : activeAgent.getSystemPrompt()}/>
                <button>
            ...
            <div className='temperatureContainer'>
                <input spellCheck="false" type="text" value={activeAgent.getTemperature()}/>
                <button>
