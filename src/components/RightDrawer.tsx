    ...
    return(
        <aside className="rightDrawer">
            ...
            <div className='contextContainer'>
                ...
                />
                <button>
                    <svg style={{opacity:0.85}} width="24" height="24" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='maxTokensContainer'>
                ...
                />
                <button>
                    <svg style={{opacity:0.80}} width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
