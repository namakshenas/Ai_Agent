...
export default function LeftDrawer(){
    return(
        <aside className="leftDrawer">
            <figure>OSspita for <img src={ollama}/></figure>
            <h3>
            ...
            <ul>
                ...
                <li role="button" className='active'>how long does it take to travel to Mars?</li>
                <li role="button">how does photosynthesis work?</li>
            </ul>
            <div style={{display:'flex', columnGap:'0.5rem'}}>
                <button style={{marginLeft:'auto'}} className='white'>
